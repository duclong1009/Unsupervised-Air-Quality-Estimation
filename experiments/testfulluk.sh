...
# wogcn
CUDA_VISIBLE_DEVICES=0 python train_egcn.py --stdgi_noise_min 0.4 --stdgi_noise_max 0.8 --name gede_uk --en_hid1 64 --en_hid2 64 --checkpoint_decoder decoder_wogcn_uk --checkpoint_stdgi stdgi_wogcn_uk --num_epochs_stdgi 1 --num_epochs_decoder 1 --model_type wogcn --dataset uk --log_wandb
# wornnencoder
